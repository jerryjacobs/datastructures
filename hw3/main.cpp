...
void additional_student_tests() {
  ...
  // =======================================================================
    ...
    for (int i = 0; i < 7; i++){
        ...
        DNA.add_piece('J',0,1);
        DNA.add_piece('J',0,0);
        DNA.add_piece('J',180,0);
        DNA.add_piece('L',180,1);
        DNA.add_piece('L',180,2);
        DNA.add_piece('L',180,3);
        DNA.add_piece('L',180,4);
    }
    for (int i = 0; i < 7; i++){
        DNA.add_piece('L',0,6);
        DNA.add_piece('L',0,7);
        DNA.add_piece('L',0,8);
        DNA.add_piece('L',0,9);
        DNA.add_piece('L',0,10);
        DNA.add_piece('L',180,10);
        DNA.add_piece('J',180,9);
        DNA.add_piece('J',180,8);
        DNA.add_piece('J',180,7);
        DNA.add_piece('J',180,6);
    }
    DNA.print();
    DNA.destroy();
